...
The project is a small, single-process Pygame application organized into focused modules.

**Core modules**
- Game state & logic: [game.py](../game.py)
- Runtime entry point & UI: [main.py](../main.py)
- Entities: [enemy.py](../enemy.py), [tower.py](../tower.py), [projectile.py](../projectile.py)
- Configuration constants: [config.py](../config.py)
- Tests: [test_game.py](../test_game.py)

**High-level flow**
1. [main.py](../main.py) initializes Pygame and starts the game loop.
2. `Game` in [game.py](../game.py) owns state (money, lives, wave, entities, speed).
...
**Projectiles** ([projectile.py](../projectile.py))
...
The UI is built directly in Pygame inside [main.py](../main.py).
